var Category = (function () {
    ...
    function BindCategoryList() {
        var BindCategorySuccess = function (result) {
            if (result != "" || result.length >= 0) {
                $('#competitionCategorylist').DataTable({
                    data: result,
                    "bFilter": true,
                    "bLengthChange": true,
                    "bDestroy": true,
        ...
        var url = '/PudhariAdmin/Competition/GetCategoryList/';
    ...
    $('body').on('click', "#btnSubmit", function () {
        ...
        var categoryID = CommonUtility.ScriptInjection($("#hdnCompetitionCategoryID").val()).replace(/</g, "").replace(/>/g, "");
    ...
    function AddCategory(categoryName, categoryDesc, categoryStatus) {
        ...
        var url = '/PudhariAdmin/Competition/Category/';
    ...
    function UpdateCategory(categoryName, categoryDesc, categoryStatus, categoryID) {
        ...
        var url = '/PudhariAdmin/Competition/UpdateCategory/';
        CommonUtility.RequestAjax('POST', url, data, CategorySuccess, null, null, null);
    }
    //#endregion
    ...
    function Clear() {
        $("#txtCategoryName").val("");
        $("#txtCategoryDesc").val("");
        $("#hdnCompetitionCategoryID").val("");
        $("#ddlCategoryStatus").val("True");
    ...
    function DeleteCategory(CategoryID) {
        ...
        var url = '/PudhariAdmin/Competition/DeleteCategory/';
        CommonUtility.RequestAjax('POST', url, data, CategorySuccess, null, null, null);
    }
    //#endregion
    ...
    $('body').on('click', "#editcategory", function () {
        ...
        var BindCategorySuccess = function (result) {
            if (result != "" || result.length >= 0) {
                ...
                $("#hdnCompetitionCategoryID").val(result.CategoryId);
            }
        }
        var data = {
            CategoryID: catID
        };
        var url = '/PudhariAdmin/Competition/GetCategoryByID/';
